  ...
  <div id="wrapper">
    ...
    <main>
      <section id="slideshow">
        <div id="slideshowcontainer" class="slide">
          <img src="images/slideshow_1.png" alt="Slideshow Image">
          <img src="images/slideshow_2.jpg" alt="Slideshow Image">
          <img src="images/slideshow_3.jpg" alt="Slideshow Image">
          <img src="images/slideshow_4.jpg" alt="Slideshow Image">
          <img src="images/slideshow_5.jpg" alt="Slideshow Image">
          <img src="images/slideshow_6.jpg" alt="Slideshow Image">
          <img src="images/slideshow_7.jpg" alt="Slideshow Image">
          <img src="images/slideshow_8.jpg" alt="Shideshow Image">
        </div>
      </section>
      <div id="merchcontainer">
        <a href="shop.html">
          <img id="merchbanner" src="images/shop_merch.png" alt="Full Tilt Merch Link">
        </a>
      </div>
    </main>
    <footer>
