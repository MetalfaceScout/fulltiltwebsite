...
<html lang="en">
  <head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Chivo:wght@7000&display=swap" rel="stylesheet">
    <title>FULL TILT - Shop</title>
  </head>
  <body>
  <div id="wrapper">
    <header>
    ...
    <main>
    <div id="my-store-74141261"></div>
    <div>
    <script data-cfasync="false" type="text/javascript" src="https://app.ecwid.com/script.js?74141261&data_platform=code&data_date=2022-04-15" charset="utf-8"></script><script type="text/javascript"> xProductBrowser("categoriesPerRow=3","views=grid(20,3) list(60) table(60)","categoryView=grid","searchView=list","id=my-store-74141261");</script>
    </div>
    </main>
    <footer>
